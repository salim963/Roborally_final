...
public class Player extends Subject {
    ...
    public Player(@NotNull Board board, String color, @NotNull String name) {
        this(null, board, color, name);
    }

    public Player(Integer id, @NotNull Board board, String color, @NotNull String name) {
        this.id = id;
        this.board = board;
        this.name = name;
        this.color = color;
    ...
    /**
     * This method updates the checkpoint number everytime you reach a new checkpoint by one
     * @param recentCheckPoint
     * @author Muhammad Ali Khan Bangash(s092512@student.dtu.dk)
     * @author Salim Omar s193472@dtu.dk
     */
    public void updateCheckPointNumber(int recentCheckPoint) {
