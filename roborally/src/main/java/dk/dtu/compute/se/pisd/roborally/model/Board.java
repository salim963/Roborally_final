...
public class Board extends Subject {
    ...
    private List<CheckPointAction> checkPoints = new ArrayList<>();
    ...
    public Space getPreviousNeighbour(@NotNull Space space, @NotNull Heading heading) {
        int x = space.x;
        int y = space.y;
        switch (heading) {
            case SOUTH:
    ...
    public List<CheckPointAction> getCheckPoints() {
        return this.checkPoints;
    }

    public void addCheckpoint(CheckPointAction checkpoint) {
